...
Route::middleware(['auth', 'legacy.password.change'])->group(function () {
    ...
    Route::post('/peticoes/{modelo}', 'PeticaoAssemblyController@compose')->name('legacy.peticoes.modelos.compose');
    Route::post('/peticoes/{modelo}/editor', 'PeticaoEditorController@create')->name('legacy.peticoes.modelos.editor.create');
    ...
    Route::post('/peticoes/{modelo}/peticao-normalizada', 'PeticaoSavedController@storeFromPreview')->name('legacy.peticoes.modelos.saved.store');
    Route::post('/peticoes/{modelo}/salvar', 'PeticaoEditorController@save')->name('legacy.peticoes.modelos.editor.save');
    Route::post('/peticoes/{modelo}/exportar/pdf', 'PeticaoEditorController@exportPdf')->name('legacy.peticoes.modelos.editor.export.pdf');
    Route::post('/peticoes/{modelo}/exportar/word', 'PeticaoEditorController@exportWord')->name('legacy.peticoes.modelos.editor.export.word');
