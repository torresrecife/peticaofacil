...
function fc_botoes_usu($id_usu,$displ,$nome=""){
	...
	return "<div id='module-status' style='display:" . $displ . ";'>
				<span class='editar'><a href='javascript:fc_edit_usu(\"$id_usu\",\"U\");' class='button_del' title='Editar Usu�rio'>Editar</a></span>
				<span class='excluir'><a href='javascript:fc_del_usu(\"$id_usu\",\"$nomeJs\");' class='button_del' title='Excluir Usu�rio'>Excluir</a></span>
			</div>";
}
